...
var departureCode = document.querySelector('#departure');
var arriveCode = document.querySelector('#arrive');
var airLine = document.querySelector('#airLine');
var limitResults = document.querySelector('#limit');
...
function fetchFlights() {
  return _fetchFlights.apply(this, arguments);
}
function _fetchFlights() {
  _fetchFlights = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var params;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          params = new URLSearchParams({
            access_key: '8e2027ea461738ba037a09d109c8df98',
            limit: limitFligths,
          ...
          _context.next = 3;
          return fetch("http://api.aviationstack.com/v1/flights?".concat(params)).then(function (res) {
            return res.json();
          }).then(function (data) {
            ...
            products.forEach(function (element) {
              if (element.length !== 0) {
                card += "\n                <div class=\"individualFlight\">\n                    <h4>".concat(element.airline.name, "</h4>\n                    <div class=\"trip\">\n                        <div class=\"departureTime\">\n                            <p class=\"timeD\">").concat(element.departure.scheduled, "</p>\n                            <p class=\"iataD\">").concat(element.departure.iata, "</p>\n                        </div>\n                        <div class=\"iconFly\">\n                            <img src = \"./img/airplaneCard.png\"/>\n                            <span></span>\n                        </div>\n                        <div class=\"arriveTime\">\n                            <p class=\"timeA\">").concat(element.arrival.estimated, "</p>\n                            <p class=\"iataA\">").concat(element.arrival.iata, "</p>\n                        </div>\n\n                    </div>\n                    <div class=\"flightThings\">\n                        <p>").concat(element.flight_date, "</p>\n                        <p>").concat(element.flight_status, "</p>\n                        <button class=\"btn btn-success\" id = \"buttonBuy\" value=\"\">Buy Now</button>\n                    </div>\n                \n                </div>");
              }
